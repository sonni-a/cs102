...
def remove_wall(grid: List[List[Union[str, int]]], coord: Tuple[int, int]) -> List[List[Union[str, int]]]:
    ...
    dir = choice(("up", "r"))
    if (coord[1] == len(grid[0]) - 2 or dir == "up") and coord[0] > 2 and coord[0] % 2 != 0:
        grid[coord[0] - 1][coord[1]] = " "
    elif (coord[0] == 1 or dir == "r") and coord[1] < len(grid[0]) - 3 and coord[1] % 2 != 0:
...
def shortest_path(
    ...
    while grid[currcell[0]][currcell[1]] < 1 or grid[currcell[0]][currcell[1]] > 1:
        if currcell[0] > 0 and grid[currcell[0] - 1][currcell[1]] == k - 1:
            ...
            nextc = (currcell[0] + 1, currcell[1])
        elif currcell[1] > 0 and grid[currcell[0]][currcell[1] - 1] == k - 1:
            nextc = (currcell[0], currcell[1] - 1)
        elif currcell[0] < len(grid[0]) - 1 and grid[currcell[0]][currcell[1] + 1] == k - 1:
            nextc = (currcell[0], currcell[1] + 1)
        else:
            grid[currcell[0]][currcell[1]] = " "
